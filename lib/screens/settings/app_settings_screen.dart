    ...
    return _buildExpandableCard(
      ...
      children: [
        bitDropdown('Start', _dioConfig.start,
            (v) => setState(() => _dioConfig = _dioConfig.copyWith(start: v))),
        bitDropdown('Stop', _dioConfig.stop,
            (v) => setState(() => _dioConfig = _dioConfig.copyWith(stop: v))),
        bitDropdown('Execute Refill', _dioConfig.executeRefill,
            (v) => setState(() => _dioConfig = _dioConfig.copyWith(executeRefill: v))),
        bitDropdown('Trigger Emptying', _dioConfig.triggerEmptying,
            (v) => setState(() => _dioConfig = _dioConfig.copyWith(triggerEmptying: v))),
        bitDropdown('Interlock', _dioConfig.interlock,
            (v) => setState(() => _dioConfig = _dioConfig.copyWith(interlock: v))),
        bitDropdown('Tare', _dioConfig.tare,
            (v) => setState(() => _dioConfig = _dioConfig.copyWith(tare: v))),
