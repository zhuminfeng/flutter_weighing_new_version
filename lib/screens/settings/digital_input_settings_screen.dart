...
class DigitalInputSettingsScreen extends StatefulWidget {
  ...
  const DigitalInputSettingsScreen({super.key, required this.subsystemId});
...
class _DigitalInputSettingsScreenState
  ...
  void _removeBinding(int index) {
    final list = List<DigitalInputBinding>.from(_cfg.bindings)..removeAt(index);
    setState(() {
      _cfg = DigitalInputMapConfig(version: _cfg.version, bindings: list);
    });
  }
...
class _DigitalInputBindingCardState extends State<_DigitalInputBindingCard> {
  ...
  void initState() {
    super.initState();
    _ioPosCtrl = TextEditingController(text: widget.binding.ioPos.toString());
    _channelCtrl = TextEditingController(
      text: widget.binding.channel.toString(),
    );
    _bitIndexCtrl = TextEditingController(
      text: widget.binding.bitIndex.toString(),
    );
  }
